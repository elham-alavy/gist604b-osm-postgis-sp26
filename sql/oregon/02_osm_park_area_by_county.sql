-- Query 2: Park Area by County in Oregon
-- Purpose: Calculate the total park area (sq km) in each Oregon county
...
-- - Use ST_Area(geom::geography) for accurate area on WGS84
